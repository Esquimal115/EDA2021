...
public class GUIEditorPredictivo extends JFrame implements 
    ...
    private class JPanelRound extends JPanel {
         ...
         * @param colorPrim Nuevo color primario del panel
         */        
         ...
         * @param colorSec Nuevo color secundario del panel
         */
         ...
         * @param colorCont Nuevo color de contorno del panel
         */
         ...
         * @param a  Nueva anchura del arco
         */
    ...
    private class JButtonRound extends JButton {
         ...
         * @param pos      Posici??n vertical del boton
         */
