...
public class TestGrafo {
    ...
    public static String testArista() {
        Arista prueba = new Arista(0, 2, 12.5D);
        if (prueba.origen == 0 && prueba.destino == 2 && prueba.peso == 12.5D) {
    ...
    private static String testSTConexo() {
        ...
        Arista[] sol = new Arista[]{new Arista(0, 1, 6.0D), new Arista(0, 2, 12.0D), new Arista(0, 3, 14.0D), new Arista(1, 5, 20.0D), new Arista(2, 4, 12.0D), new Arista(5, 6, 15.0D)};
